...
export function LandingNavbar({ activeSection, scrollTo }: { activeSection: string; scrollTo: (id: string) => void }) {
    ...
    return (
        <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-xl border-b border-gray-100/80 shadow-sm" aria-label="Main navigation">
            <div className="max-w-7xl mx-auto px-0 h-[72px] flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 ml-4">
                    ...
                    <a href="/booking" className="hidden sm:flex items-center gap-3 px-4 py-2.5 bg-gradient-to-r from-[#3C81C6] to-[#1d4ed8] hover:from-[#2a6da8] hover:to-[#1e40af] text-white rounded-xl text-sm font-bold transition-all hover:-translate-y-0.5 shadow-lg shadow-blue-500/25 active:scale-95"
